...
public final class SDK_Auth {
    ...
    private SDK_Auth(final Context context,
                     ...
                     final SDK_AuthHandler userHandler,
        ...
        this.scopes = scopes;
        this.user = new SDK_AuthClient(context, this);
        ...
        this.awsKeyValueStore = new AWSKeyValueStore(context,
                SDK_ClientConstants.APP_LOCAL_CACHE,
    ...
    /**
     * @return an instance of {@link SDK_Auth} after setting to the last authenticated user on
     * the device.
     */
    public SDK_Auth getCurrentUser() {
        this.user.setUsername(SDK_LocalDataManager.getLastAuthUser(awsKeyValueStore, context, appId));
        return this;
    }
    ...
    /**
     * @return Scopes set for this {@link SDK_Auth} instance.
     */
    ...
    /**
     * @return The username set for this {@link SDK_Auth} instance.
     */
    ...
    /**
     * Set a username for the {@link SDK_Auth} instance.
     *
     * @param username Required: The username of the user in your Cognito User-Pool.
     * @return {@link SDK_Auth}.
     */
    public SDK_Auth setUsername(final String username) {
        this.user.setUsername(username);
        return this;
    }

    /**
     * @return Sign-In redirect uri set for this {@link SDK_Auth} instance.
     */
    ...
    /**
     * @return Sign-Out redirect uri set for this {@link SDK_Auth} instance.
     */
    ...
    /**
     * @return Identity Provider set for this {@link SDK_Auth} instance.
     */
    ...
    /**
     * @return Identity Provider identifier set for this {@link SDK_Auth} instance.
     */
    ...
    /**
     * @return Extra customization bundle for this {@link SDK_Auth} instance.
     */
     ...
     * {@link SDK_AuthHandler#onSuccess(SDK_AuthUserSession)}.
     * <p>
     ...
     * authentication code through the redirect uri. Call {@link SDK_Auth#getTokens(Uri)} to
     ...
     *
     * @param SDKAuthHandler
     */
    public void setAuthHandler(final SDK_AuthHandler SDKAuthHandler) {
        this.user.setUserHandler(SDKAuthHandler);
    }
    ...
    /**
     * Release resources used by {@link SDK_Auth}
     */
    public void release() {
    ...
    /**
     * Builder class for {@link SDK_Auth} objects.
     */
    public static final class Builder {
         ...
         * Callback handler.
         */
        private SDK_AuthHandler mUserHandler;
        ...
        /**
         * Set the callback handler for {@link SDK_Auth}.
         *
         * @param mUserHandler Required: {@link SDK_AuthHandler}.
         * @return A reference to this builder.
         */
        @SuppressWarnings("checkstyle:hiddenfield")
        public Builder setAuthHandler(final SDK_AuthHandler mUserHandler) {
        ...
        /**
         * Instantiates {@link SDK_Auth} with the set options.
         *
         * @return {@link SDK_Auth}.
         */
        public SDK_Auth build() {
            validateCognitoAuthParameters();
            return new SDK_Auth(this.mAppContext,
                    this.mUserPoolId,
                    this.mAppWebDomain,
                    this.mAppClientId,
                    this.mAppSecret,
        ...
        /**
         * Checks if all required parameters are available to instantiate {@link SDK_Auth}.
         */
        private void validateCognitoAuthParameters() {
            ...
            try {
                ...
                if (error) {
                    throw new SDKAuthInvalidParameterException(errorMessage.toString());
                }
            } catch (Exception e) {
                throw new SDKAuthInvalidParameterException("validation failed", e);
            }
        }
