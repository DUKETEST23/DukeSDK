...
public class SDK_AuthClientException extends RuntimeException {
    /**
     * Exception unique id.
     */
     ...
     */
    public SDK_AuthClientException(String message, Throwable t) {
        super(message, t);
    }
     ...
     * @param message An error message describing why this exception was thrown.
     */
    public SDK_AuthClientException(String message) {
        super(message);
    }
