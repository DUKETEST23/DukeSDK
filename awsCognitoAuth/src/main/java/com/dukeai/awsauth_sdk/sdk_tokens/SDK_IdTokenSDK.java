 ...
 */
public class SDK_IdTokenSDK extends SDK_UserToken {
     ...
     */
    public SDK_IdTokenSDK(String jwtToken) {
        super(jwtToken);
    }
    ...
    public Date getNotBefore() throws Exception {
        String claim = SDK_JWTParser.getClaim(super.getToken(), "nbf");
        if (claim == null) {
            return null;
        }
        long epocTimeSec = Long.parseLong(claim);
    ...
    public Date getIssuedAt() throws Exception {
        String claim = SDK_JWTParser.getClaim(super.getToken(), "iat");
        if (claim == null) {
            return null;
        }
        long epocTimeSec = Long.parseLong(claim);
    ...
    public String getCognitoUsername() throws Exception {
        return SDK_JWTParser.getClaim(super.getToken(), "cognito:username");
    }
}
