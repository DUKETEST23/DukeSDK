...
public final class Auth_SDK {
    ...
    private Auth_SDK(final Context context,
                     ...
                     final AuthHandler_SDK userHandler,
        ...
        this.scopes = scopes;
        this.user = new AuthClient_SDK(context, this);
        ...
        this.awsKeyValueStore = new AWSKeyValueStore(context,
                ClientConstants_SDK.APP_LOCAL_CACHE,
    ...
    /**
     * @return an instance of {@link Auth_SDK} after setting to the last authenticated user on
     * the device.
     */
    public Auth_SDK getCurrentUser() {
        this.user.setUsername(LocalDataManager_SDK.getLastAuthUser(awsKeyValueStore, context, appId));
        return this;
    }
    ...
    /**
     * @return Scopes set for this {@link Auth_SDK} instance.
     */
    ...
    /**
     * @return The username set for this {@link Auth_SDK} instance.
     */
    ...
    /**
     * Set a username for the {@link Auth_SDK} instance.
     *
     * @param username Required: The username of the user in your Cognito User-Pool.
     * @return {@link Auth_SDK}.
     */
    public Auth_SDK setUsername(final String username) {
        this.user.setUsername(username);
        return this;
    }

    /**
     * @return Sign-In redirect uri set for this {@link Auth_SDK} instance.
     */
    ...
    /**
     * @return Sign-Out redirect uri set for this {@link Auth_SDK} instance.
     */
    ...
    /**
     * @return Identity Provider set for this {@link Auth_SDK} instance.
     */
    ...
    /**
     * @return Identity Provider identifier set for this {@link Auth_SDK} instance.
     */
    ...
    /**
     * @return Extra customization bundle for this {@link Auth_SDK} instance.
     */
     ...
     * {@link AuthHandler_SDK#onSuccess(AuthUserSession_SDK)}.
     * <p>
     ...
     * authentication code through the redirect uri. Call {@link Auth_SDK#getTokens(Uri)} to
    ...
    /**
     * Use this method to get new tokens for a user, the tokens are returned though the callback.
     * {@link AuthHandler_SDK#onSuccess(AuthUserSession_SDK)}.
     * <p>
     * <b>Note</b>: This SDK uses OAuth Code-Grant flow with PKCE, for authentication. To get
     ...
     * </p>
     */
    public void getRefreshSession() {
        this.user.getRefreshSession();
    }
     ...
     *
     * @param authHandlerSDK
     */
    public void setAuthHandler(final AuthHandler_SDK authHandlerSDK) {
        this.user.setUserHandler(authHandlerSDK);
    }
    ...
    /**
     * Release resources used by {@link Auth_SDK}
     */
    public void release() {
    ...
    /**
     * Builder class for {@link Auth_SDK} objects.
     */
    public static final class Builder {
         ...
         * Callback handler.
         */
        private AuthHandler_SDK mUserHandler;
        ...
        /**
         * Set the callback handler for {@link Auth_SDK}.
         *
         * @param mUserHandler Required: {@link AuthHandler_SDK}.
         * @return A reference to this builder.
         */
        @SuppressWarnings("checkstyle:hiddenfield")
        public Builder setAuthHandler(final AuthHandler_SDK mUserHandler) {
        ...
        /**
         * Instantiates {@link Auth_SDK} with the set options.
         *
         * @return {@link Auth_SDK}.
         */
        public Auth_SDK build() {
            validateCognitoAuthParameters();
            return new Auth_SDK(this.mAppContext,
                    this.mUserPoolId,
                    this.mAppWebDomain,
                    this.mAppClientId,
                    this.mAppSecret,
        ...
        /**
         * Checks if all required parameters are available to instantiate {@link Auth_SDK}.
         */
        private void validateCognitoAuthParameters() {
            ...
            try {
                ...
                if (error) {
                    throw new AuthInvalidParameterException_SDK(errorMessage.toString());
                }
            } catch (Exception e) {
                throw new AuthInvalidParameterException_SDK("validation failed", e);
            }
        }
