...
public final class SDK_AuthHttpClient {
    ...
    public String httpPost(final URL uri, final Map<String, String> headerParams, final Map<String, String> bodyParams) throws Exception {
        if (uri == null || bodyParams == null || bodyParams.size() < 1) {
            throw new SDK_AuthClientException("Invalid http request parameters");
        }
        ...
        try {
            // Request header
            httpsURLConnection.setRequestMethod(SDK_ClientConstants.HTTP_REQUEST_TYPE_POST);
            ...
            if (responseCode >= HttpURLConnection.HTTP_OK &&
                ...
                throw new SDKAuthServiceException(httpsURLConnection.getResponseMessage());
            }
