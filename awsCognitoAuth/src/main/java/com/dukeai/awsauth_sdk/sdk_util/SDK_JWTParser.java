...
public class SDK_JWTParser {
    ...
    public static JSONObject getHeader(String JWT) {
        try {
            ...
            throw new SDKAuthInvalidParameterException("error while parsing JSON", e);
        }
    }
    ...
    public static void validateJWT(String JWT) {
        ...
        if (jwtParts.length < JWT_PARTS) {
            throw new SDKAuthInvalidParameterException("Not a JSON Web Token");
        }
    }
}
