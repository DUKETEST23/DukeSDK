...
public final class AuthHttpClient_SDK {
    ...
    public String httpPost(final URL uri, final Map<String, String> headerParams, final Map<String, String> bodyParams) throws Exception {
        if (uri == null || bodyParams == null || bodyParams.size() < 1) {
            throw new AuthClientException_SDK("Invalid http request parameters");
        }
        ...
        try {
            // Request header
            httpsURLConnection.setRequestMethod(ClientConstants_SDK.HTTP_REQUEST_TYPE_POST);
            ...
            if (responseCode >= HttpURLConnection.HTTP_OK &&
                ...
                throw new AuthServiceException_SDK(httpsURLConnection.getResponseMessage());
            }
