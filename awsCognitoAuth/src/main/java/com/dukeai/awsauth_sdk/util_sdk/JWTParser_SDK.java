...
public class JWTParser_SDK {
    ...
    public static JSONObject getHeader(String JWT) {
        try {
            ...
            throw new AuthInvalidParameterException_SDK("error while parsing JSON", e);
        }
    }
    ...
    public static void validateJWT(String JWT) {
        ...
        if (jwtParts.length < JWT_PARTS) {
            throw new AuthInvalidParameterException_SDK("Not a JSON Web Token");
        }
    }
}
