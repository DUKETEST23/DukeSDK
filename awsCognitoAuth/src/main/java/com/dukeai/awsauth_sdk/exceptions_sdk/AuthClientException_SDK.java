...
public class AuthClientException_SDK extends RuntimeException {
    /**
     * Exception unique id.
     */
     ...
     */
    public AuthClientException_SDK(String message, Throwable t) {
        super(message, t);
    }
     ...
     * @param message An error message describing why this exception was thrown.
     */
    public AuthClientException_SDK(String message) {
        super(message);
    }
