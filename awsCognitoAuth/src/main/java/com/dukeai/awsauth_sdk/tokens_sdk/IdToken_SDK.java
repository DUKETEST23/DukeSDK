package com.dukeai.awsauth_sdk.tokens_sdk;
...
import com.dukeai.awsauth_sdk.util_sdk.JWTParser_SDK;
 ...
 */
public class IdToken_SDK extends UserToken_SDK {
     ...
     */
    public IdToken_SDK(String jwtToken) {
        super(jwtToken);
    }
    ...
    public Date getExpiration() throws Exception {
        String claim = JWTParser_SDK.getClaim(super.getToken(), "exp");
        if (claim == null) {
            return null;
        }
    ...
    public Date getNotBefore() throws Exception {
        String claim = JWTParser_SDK.getClaim(super.getToken(), "nbf");
        if (claim == null) {
            return null;
        }
        long epocTimeSec = Long.parseLong(claim);
    ...
    public Date getIssuedAt() throws Exception {
        String claim = JWTParser_SDK.getClaim(super.getToken(), "iat");
        if (claim == null) {
            return null;
        }
        long epocTimeSec = Long.parseLong(claim);
    ...
    public String getCognitoUsername() throws Exception {
        return JWTParser_SDK.getClaim(super.getToken(), "cognito:username");
    }
}
